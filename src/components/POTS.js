...
import Picture from '../assets/pots-graphic.jpg';
                    ...
                    <div className="body">
                        <div className="container full-image">
                            <div className="header full-image">
                                ...
                                <p className="item-b">full-size-image-p.html</p>
                            </div>
                                ...
                                <div className="center-full-size">
                                    <div className="full-size-image-container">
                                        <div className="full-size-image-header">
                                            ...
                                            <p className="item-b">pots-graphic.jpeg</p>
                                        </div>

                                        <div className="full-size-container-pots">
                                            <img src={Picture} alt="pots-graphic-size-image" />
                                        </div>
                                    </div>
