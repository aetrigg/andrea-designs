...
import Picture from '../assets/meredith-foster-portrait.JPG';
                    ...
                    <div className="body">
                        <div className="container full-image">
                            <div className="header full-image">
                                ...
                                <p className="item-b">full-size-image-m.html</p>
                            </div>
                                ...
                                <div className="center-full-size">
                                    <div className="full-size-image-container">
                                        <div className="full-size-image-header">
                                            ...
                                            <p className="item-b">meredith-foster-portrait.jpeg</p>
                                        </div>

                                        <div className="full-size-container-meredith">
                                            <img src={Picture} alt="meredith-full-size-image" />
                                        </div>
                                    </div>
